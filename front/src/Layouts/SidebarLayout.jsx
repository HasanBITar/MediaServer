const SidebarLayout = ({ sidebar, children }) => {
    return (
        <>
            <aside id="sidebar-multi-level-sidebar" className="fixed flex top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="flex-1 m-2 mt-[4.25rem] overflow-y-auto rounded bg-gray-800 p-2 lg:p-4">
