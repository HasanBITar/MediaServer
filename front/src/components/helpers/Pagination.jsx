    ...
    return (
        <div className="flex w-fit p-1 bg-gray-menu mx-auto rounded-md space-x-1">
            ...
            {pages.map(page =>
                <div
                    key={page}
                    className={`flex items-center justify-center px-4 py-2 mx-1 transition-colors duration-300 transform bg-white rounded sm:inline dark:bg-gray-800 dark:text-gray-200 hover:bg-blue-500 dark:hover:bg-blue-500 hover:text-white ${currentPage === page ? 'dark:bg-blue-700 dark:text-blue-500' : 'dark:text-gray-200'}`}
