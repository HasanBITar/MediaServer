...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900 sticky top-0 z-50">
      <div className="max-w-screen-xxl flex flex-wrap items-center justify-between mx-auto px-2 py-3">
        <Logo />
        ...
        <div className={`items-center justify-between w-full mr-auto ml-0 bg-gray-800 rounded-md p-2 mt-2
          lg:flex lg:w-auto lg:order-1 lg:ml-6 lg:bg-transparent lg:mt-0 ${isMenuOpen ? 'block' : 'hidden lg:block'}`}
        >
