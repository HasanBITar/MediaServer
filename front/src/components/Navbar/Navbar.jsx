  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900 sticky top-0 z-50">
      <div className="max-w-screen-xxl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex lg:order-2">
          ...
          <div className="relative hidden lg:block min-w-80">
            ...
            <input
              ...
              type="text"
              id="search-navbar"
              className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 
        ...
        <div
          className="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1 lg:ml-6 mr-auto ml-0"
          id="navbar-search"
        >
